...
async function loadTickets(){
  ...
  document.querySelectorAll(".copyTicket").forEach(b=>b.onclick=async()=>{await navigator.clipboard.writeText(b.dataset.url); $("msg").textContent="Enlace de la boleta copiado. Pégalo en WhatsApp.";});
}
